...
public class ChatUpMixin {
    ...
    private int getOffset() {
        ...
        int offset = player.getArmor() > 0 ? 20 : 0;
        if (player.getAbsorptionAmount() > 0) offset += 20;
        return offset;
    }
    ...
    @ModifyConstant(method = "getText", constant = @Constant(doubleValue = 80.0))
